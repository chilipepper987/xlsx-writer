...
class XLSXWriter {
    ...
    /**
     * Change this to a directory for temp files.
     * It must be writable by the user running this class,
     * typically you if on CLI, or apache if in browser.
     */
    const TEMP_DIRECTORY = /* "/mnt/fileshares/bucket */
        "/tmp";
...
//set up the output
        ...
        $this->_tempFolderName; // = $tempFolderName = self::TEMP_DIRECTORY . "/" . uniqid("csv2xlsx");
        //mkdir($tempFolderName);
        //create the xlsx folder structure in the temp folder
